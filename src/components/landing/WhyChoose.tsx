  ...
  return (
    <section className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {reasons.map((reason, index) => {
            ...
            return (
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-br from-blue-100 to-emerald-100 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 blur-xl"></div>

                <div className="relative bg-white rounded-2xl p-8 shadow-lg shadow-gray-200/50 hover:shadow-xl transition-all duration-300 border border-gray-100">
                  <div className="flex gap-6">
                    <div className="flex-shrink-0">
                      <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-blue-600 to-emerald-600 flex items-center justify-center shadow-lg">
                    ...
                    <div className="flex-1 space-y-3">
                      ...
                      <div className="pt-2">
                        <div className="inline-flex items-baseline gap-2 bg-gradient-to-r from-blue-50 to-emerald-50 px-4 py-2 rounded-lg border border-blue-100">
        ...
        <div className="mt-16 bg-gradient-to-r from-blue-600 to-emerald-600 rounded-3xl p-12 text-center shadow-2xl">
